...
- **Numerical approach**:
  ...
  - Used `differential_evolution` to identify the minimum payoff difference.
...
- `differential_evolution` — verification and adjustment of static hedge payoffs
